"""TTPHUNT core — Hunt MITRE ATT&CK techniques across logs with a rule pack."""
...
RULES = [
    ("TTP-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("TTP-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("TTP-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
