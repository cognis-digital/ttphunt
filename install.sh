#!/usr/bin/env sh
# Universal installer for ttphunt. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/ttphunt.git"
echo "Installing ttphunt ..."
